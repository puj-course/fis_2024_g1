 ...
 * @author Usuario 1
 */
public class PaginaCancelarReserva extends javax.swing.JFrame {

    /**
     * Creates new form PaginaCancelarReserva
     */
    public PaginaCancelarReserva() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        buttonCrear.setText("Cancelar reserva");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaginaCancelarReserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaginaCancelarReserva().setVisible(true);
            }
        });
    }
